...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // NOW attach event listeners after the HTML is inserted
  ...
  document
    .querySelectorAll(".dropdown-column a, nav ul li > a:not(.dropdown-toggle)")
    .forEach((link) => {
  ...
  document.addEventListener("click", function (e) {
    if (nav && nav.classList.contains("active") && window.innerWidth <= 992) {
